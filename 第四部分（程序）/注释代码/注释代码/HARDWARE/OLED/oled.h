...
#define LED_ON       HAL_GPIO_WritePin(GPIOD,GPIO_PIN_13, GPIO_PIN_RESET)
#define LED_OFF      HAL_GPIO_WritePin(GPIOD,GPIO_PIN_13, GPIO_PIN_SET)
...
#define OLED_SDA_Clr() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_11, GPIO_PIN_RESET)//SDA
...
#define OLED_RES_Set() HAL_GPIO_WritePin(GPIOE,GPIO_PIN_14, GPIO_PIN_SET)
